...
namespace MegamanXNALibrary
{
    public class FireMegamanDecorator : MegamanDecorator
    {
        ...
        public override void LoadContent(ContentManager theContentManager)
        {
            ...
            {
                aLemon.LoadContent(theContentManager, "Fire");
            }
            ...
            if (mCurrentState == State.Walking)
            {
                if (Keyboard.GetState().IsKeyUp(Keys.Right & Keys.Left))
                {
                    ...
                    if (aCreateNew == true)
                    {
                        ...
                        aLemon.LoadContent(mContentManager, "Fire");
        ...
        public FireMegamanDecorator(IMegaman IMegamanDecorator, Vector2 position)
