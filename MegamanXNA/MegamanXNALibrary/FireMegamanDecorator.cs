...
{
    public class FireMegamanDecorator : MegamanDecorator
    {
        ...
        const string MEGAMAN_ASSETNAME = "FireD2";
        ...
        public override void UpdateBullets(Microsoft.Xna.Framework.GameTime theGameTime, Microsoft.Xna.Framework.Input.KeyboardState aCurrentKeyboardState)
        {
            foreach (Bullets aLemon in mBullets)
            {
        ...
        public override void UpdateJump(Microsoft.Xna.Framework.Input.KeyboardState aCurrentKeyboardState)
        {
            if (mCurrentState == State.Walking)
            {
        ...
        public override void UpdateMovement(Microsoft.Xna.Framework.Input.KeyboardState aCurrentKeyboardState)
        {
            if (mCurrentState == State.Walking)
            {
                mSpeed = Vector2.Zero;
        ...
        public FireMegamanDecorator(IMegaman IMegamanDecorator)
